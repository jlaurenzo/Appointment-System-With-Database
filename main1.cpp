...
int  main() {
    string name;
    int choice = 0, choice2 = -1, choice3 = -1, choice4 = -1, choice5 = -1, choice6 = -1, choice7 = -1, choice8 = -1;
    ...
    printWordByWord("Proceeding to the confirmation of the options you've selected...", 30);
    choice7 = -1;
    cout << "* * * * * * * * * * *  * * * * * * * * * * * * * * * * * * * * * *  * * * * * * * * * * * *\n";
    cout << "*                                   ══════════════════                                    *\n";
    cout << "*  < Back                              Hair Services                                      *\n";
    ...
    cout << "*                                                                                         *\n";
    cout << "* * * * * * * * * * * * * * * *  * * * * * * * * * * * * * * * * * * * * * *  * * * * * * *\n";
    printWordByWord("Press (1) if there's no changes need to be done", 40);
   ...
   if (choice3 == 1 || choice3 == 2) {
    ...
    if (!readInt(choice8)) {
                    ...
                    bool ok = false;
                                if ((choice3 == 1 || choice3 == 2) && choice8 == 250) ok = true;
                                if (choice3 == 3 && choice8 == 150) ok = true;
                                if (choice3 == 4 && choice8 == 500) ok = true;
                                if (choice3 == 5 && choice8 == 180) ok = true;
...
choice7 = -1;
   ...
   if (choice3 == 1 ) {
    ...
    if (!readInt(choice8)) {
                    ...
                    bool ok = false;
                                if (choice3 == 1 && choice8 == 500) ok = true;
                                if (choice3 == 2 && choice8 == 800) ok = true;
                                if (choice3 == 3 && choice8 == 700) ok = true;
                                if (choice3 == 4 && choice8 == 1100) ok = true;
                                if (choice3 == 5 && choice8 == 1500) ok = true;
                                if (choice3 == 6 && choice8 == 1800) ok = true;
                                if (choice3 == 7 && choice8 == 5500) ok = true;
